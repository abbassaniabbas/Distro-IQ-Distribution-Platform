...
export function buildInvoicePreviewContent(invoice, state) {
  ...
  return `
    <article class="invoice-modal-document">
      ...
      ${isSalesReceipt ? '<p class="invoice-modal-accounting-note">Representative sell-through record only. Factory revenue was already recognised when this stock was dispatched.</p>' : ""}
    ...
    <html lang="en">
      <head>
        ...
        <style>
          * { box-sizing: border-box; }
          ...
          .accounting-note { margin: 0 0 20px; padding: 10px 12px; background: #e9f8f2; color: #0b7252; font-size: 11px; font-weight: 700; }
      ...
      <body>
        <main class="invoice">
          ...
          ${isSalesReceipt ? '<p class="accounting-note">Representative sell-through record only. Factory revenue was already recognised when this stock was dispatched.</p>' : ""}
